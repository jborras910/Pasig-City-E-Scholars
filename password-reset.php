...
<html>
    ...
    <head>
        ...
        <title>Password Reset | Pasig E-Scholar</title>
            ...
            <form action="Includes/Function.php" method="POST" autocomplete="off">
                <div class="row p-2">
                    <div class="form-group col-md-12 text-left">
                        <label>Email:</label>
                        <input name="email" class="input" placeholder="&#xf0e0;  Email Address..." required>
                    </div>
                </div>
                <div class="row buttons ">
                    <div class="form-group col-md-12">
                        <button type="submit" name="password_reset_link" class="btn btn-block register">Send Password
                            Reset link</button>
                    </div>
                    <div class="form-group col-md-12">
                        <a type="button" href="login.php" class="btn cancel ">Back to the Login</a>
                    </div>
                </div>
