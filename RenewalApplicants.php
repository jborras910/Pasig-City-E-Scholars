<?php 
    ...
    if(isset($_SESSION['auth_user']['scholar_type']) && $_SESSION['auth_user']['scholar_type'] == 'new'){
        header('location: NewApplicants.php?accessdenied');
    }



    $page = 'Renewal Application form';
...
<div class="main">
    ...
    <div class="form-container">
        <form action="Includes/Function.php" method="POST" class="form" enctype="multipart/form-data">
            <input type="hidden" name="scholar_type" value="Renewal">
            ...
            <div class="form-title text-center">
                ...
                <h3 class="title">Application Form for Renewal Applicants Pasig City Scholars A.Y <span
                        class="text-danger">
            ...
            <div class="" id=''>
                <div class="form-box-title">
                    ...
                    <div class="form-group">
                        <h5>Valid id</h5>
                        <input type="file" name="valid_id" accept=".png, .jpg, .jpeg" placeholder="Choose a file..."
                            required>
                    </div>
                    <div class="form-group">
                        <h5>1X1 Picture</h5>
            ...
            <div class="hidden_form" id='form11'>
                ...
                <button type="submit" name="Renewal_Applicants_submit_btn"
    ...
    <div class="form">
        <div class="form-title text-center">
            <img class="mb-2 logo" src="Assets/PST_LOGO.png" alt="">
            <h3 class="title">Application Form for Renewal Applicants Pasig City Scholars A.Y <span class="text-danger">
                    <?php echo bcsub(date("Y"), 1)."-".date("Y"); ?></span>
            </h3>
            <hr>
            <?php include('Admin/sweetAlert.php');?>
            ...
            <div class="form-box-title userdata">
                ...
                <form action="Includes/Function.php" method="POST" class="text-left">
                    <div class="" id=''>
                        ...
                        <hr>
                        <p>Please note that we require all of the above documents to complete your application. If you
                            have any questions or need assistance with resubmitting these documents, please don't
                            hesitate to contact us. Thank you for your attention to this matter."</p>
                        <br>
    ...
    <div class="container notactive">
        <div class="form-title text-center">
            <img class="mb-2 logo" src="Assets/PST_LOGO.png" alt="">
            <h6 class="title">Application Form for New Applicants Pasig City Scholars A.Y <span class="text-danger">
                    <?php echo bcsub(date("Y"), 1)."-".date("Y"); ?> </span>
                is Temporary Close
            </h6>
            <hr>
