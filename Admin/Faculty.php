    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header">
            <div class="flex-box" style="display:flex; justify-content:space-between">
                <h2 class="mb-0">Admin Profiles<i class="fa-solid fa-user-gear ml-2"></i></h2>
                <div>


                    <a href="download_admin.php" class="btn btn-danger">
        ...
        <div class="card-body">
            ...
            $query = "SELECT * FROM users_table WHERE  active_status='active' AND user_type !='scholar' AND user_type !='Main_Admin' ";
            $query_run = mysqli_query($conn,$query);
            ?>
                <table class="table bg-light table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th><img class="rounded-circle mr-2 border" width="50px" height="50px"
                            ...
                            <th> <?php if($row['verify_status'] == '1'){ echo 'Yes';}else{ echo 'No';} ?> </th>
