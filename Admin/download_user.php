...
$sql = "SELECT * FROM users_table WHERE verify_status ='1' AND active_status='active' AND user_type='scholar'";
...
$file_name = 'USERS ' . (date('Y') - 1) . '-' . date('Y') . '.pdf';
...
$pdf->Cell(0, 10, 'PASIG CITY SCHOLARSHIP PROGRAM '.'USERS ' . (date('Y') - 1) . '-' . date('Y'), 0, 1, 'C');
