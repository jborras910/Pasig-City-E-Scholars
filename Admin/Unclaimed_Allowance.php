                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                <h5 class="h6"><strong>TOTAL UNCLAIMED ALLOWANCE SCHOLARS</strong></h5>
                            </div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?php 
                                    require 'dbconfig.php';
                                   
                                    $query = "SELECT id FROM applicants_table WHERE isApproved = 'true' AND get_allowance='false'";
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                <h5 class="h6"><strong>TOTAL CLAIMED ALLOWANCE SCHOLARS</strong></h5>
                            </div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?php 
                                    require 'dbconfig.php';
                          
                                    $query = "SELECT id FROM applicants_table WHERE isApproved = 'true' AND get_allowance='true'";
                                    $query_run = mysqli_query($conn,$query);
                                    $row = mysqli_num_rows($query_run);
                                    echo '<h1>'.$row.'</h1>';
                                    ?>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header">
            <div class="flex-box" style="display:flex; justify-content:space-between">
                <h2 class="mb-0">Unclaimed Allowance List <?php echo bcsub(date("Y"),1)."-".date("Y"); ?></h2>
                <div>
        ...
        <div class="card-body">
            ...
            <div class="card-body">
                <div class="table-responsive" id='link_server'>
                    <?php 
                $query = "SELECT * FROM applicants_table WHERE isApproved='true' AND get_allowance='false'";
                $query_run = mysqli_query($conn,$query);
                $counter = 1;
                ?>
...
<div class="container-fluid">
                        ...
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?php 
                                    ...
                                    $query = "SELECT id FROM applicants_table WHERE isApproved = 'true' AND get_allowance='false' AND assists_by='$admin_email'";
                                    $query_run = mysqli_query($conn,$query);
                                    $row = mysqli_num_rows($query_run);
                                    echo '<h1>'.$row.'</h1>';
                                    ?>
                        ...
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?php 
                                    require 'dbconfig.php';
                                    $admin_email = $_SESSION['auth_user']['Email'];
                                    $query = "SELECT id FROM applicants_table WHERE isApproved = 'true' AND get_allowance='true' AND assists_by='$admin_email'";
                                    $query_run = mysqli_query($conn,$query);
                                    $row = mysqli_num_rows($query_run);
                                    echo '<h1>'.$row.'</h1>';
                                    ?>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            $query = "SELECT * FROM applicants_table WHERE isApproved='true' AND get_allowance='false' AND assists_by='$faculty_email'";
            $query_run = mysqli_query($conn,$query);
            $counter = 1;
            ?>
                    <table class="table bg-light table-bordered" id="dataTable" width="100%" cellspacing="0">
