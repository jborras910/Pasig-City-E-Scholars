    ...
    <div class="card shadow mb-4">
        <div class="card-header">
            <div class="flex-box" style="display:flex; justify-content:space-between">
                <h2 class="mb-0">Disapproved Applicants List <?php echo bcsub(date("Y"),1)."-".date("Y"); ?></h2>
                <div>
                    <a class="btn btn-danger" href="download_disapproved_applicants.php"><i
        ...
        <div class="card-body">
            ...
            <div class="card-body">
                <div class="table-responsive" id='link_server'>
                    <?php 
                $query = "SELECT * FROM applicants_table WHERE isApproved='disapproved'";
                $query_run = mysqli_query($conn,$query);
                $counter = 1;
                ?>
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-danger">
                                    <?php echo date("F j, Y, g:i a", strtotime($row['disapproved_date']));?></td>
                                ...
                                <th class="text-center">
                                    <form action="DisapprovedScholars.php" method="POST">
...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header">
            <div class="flex-box" style="display:flex; justify-content:space-between">
                <h2 class="mb-0">Your Disapproved Scholars <?php echo bcsub(date("Y"),1)."-".date("Y"); ?></h2>
                <div>
                    <a class="btn btn-danger" href="download_report_disapproved.php"><i
        ...
        <div class="card-body">
            ...
            $query = "SELECT * FROM applicants_table WHERE isApproved='disapproved' AND assists_by='$faculty_email'";
            $query_run = mysqli_query($conn,$query);
            $counter = 1;
            ?>
                    <table class="table bg-light table-bordered" id="dataTable" width="100%" cellspacing="0">
